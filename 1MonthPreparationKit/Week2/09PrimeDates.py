...
- Now if x is divisible by 4 and 7, then we call the date a lucky date.

Example:

"02-08-2024"

The date, month and year are 2, 8 and 2024 respectively. Now, we sequentially concatinate these numbers to get a new integer 282024. As 282024 is divisible by 4 and 7, the date is lucky.
